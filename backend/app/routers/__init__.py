...
from . import (account, account_prefs, admin, ai_business, ai_clinical, ai_patient, appointments, auth,
               billing, clinical, diagnostics, documents, patients, pharmacy,
               patients_edit, queue, staff, staff_admin, staff_edit, wards)

router = APIRouter()
for module in (auth, account, account_prefs, patients, patients_edit, appointments, queue, clinical, diagnostics,
