...
insert into staff (id, staff_no, full_name, role, department, on_duty) values
  ...
  (gen_random_uuid(), 'ST-010','Dr. Lisa Thompson',  'doctor','Dermatology',  true),
  (gen_random_uuid(), 'ST-011','Dr. James Wilson',   'doctor','Orthopaedics', false);
...
declare
  ...
  conds text[][] := array[array[]::text[], array['Hypertension'], array['Asthma'],
    array['Type 2 Diabetes'], array[]::text[], array['Migraine'],
    array['Hyperlipidaemia'], array[]::text[]];
